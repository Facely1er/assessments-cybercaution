...
import { submitContactForm } from '../utils/supabase-helpers';
            ...
            <Card>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium mb-1" htmlFor="contact-company">
                        Company
                      </label>
                      <input
                        id="contact-company"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1" htmlFor="contact-reason">
                      Reason for Contact *
                    </label>
                    <select
                      id="contact-reason"
