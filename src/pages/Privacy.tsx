          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              <div className="prose max-w-none">
                ...
                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Information We Collect</h2>
                ...
                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">How We Use Your Information</h2>
                <p>
                ...
                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Disclosure of Your Information</h2>
                <p>
                ...
                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Data Security</h2>
                <p>
                  We have implemented appropriate technical and organizational security measures designed to protect the security of any personal information we process. However, please also remember that we cannot guarantee that the internet itself is 100% secure.
                </p>

                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Your Data Protection Rights</h2>
                <p>
                ...
                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Children's Privacy</h2>
                <p>
                ...
                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Changes to This Privacy Policy</h2>
                <p>
