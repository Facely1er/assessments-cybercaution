          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              <div className="prose max-w-none">
                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Introduction</h2>
                <p>
                ...
                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Subscription and Accounts</h2>
                <h3 className="text-xl font-semibold mb-3 mt-6 text-foreground">Account Registration</h3>
                <p>
                  When you create an account with us, you must provide accurate, complete, and current information. Failure to do so constitutes a breach of the Terms, which may result in immediate termination of your account.
                </p>

                <h3 className="text-xl font-semibold mb-3 mt-6 text-foreground">Account Responsibility</h3>
                <p>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-foreground">Subscription Terms</h3>
                <p>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-foreground">Fee Changes</h3>
                <p>
                ...
                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Intellectual Property</h2>
                <h3 className="text-xl font-semibold mb-3 mt-6 text-foreground">Service Content</h3>
                <p>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-foreground">User Content</h3>
                <p>
                ...
                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Acceptable Use</h2>
                <p>
                ...
                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Termination</h2>
                <p>
                  We may terminate or suspend your account immediately, without prior notice or liability, for any reason whatsoever, including without limitation if you breach the Terms. Upon termination, your right to use the Service will immediately cease.
                </p>

                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Limitation of Liability</h2>
                <p>
                ...
                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Disclaimer</h2>
                <p>
                  Your use of the Service is at your sole risk. The Service is provided on an "AS IS" and "AS AVAILABLE" basis. The Service is provided without warranties of any kind, whether express or implied, including, but not limited to, implied warranties of merchantability, fitness for a particular purpose, non-infringement, or course of performance.
                </p>

                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Governing Law</h2>
                <p>
                ...
                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Changes to Terms</h2>
                <p>
                  We reserve the right, at our sole discretion, to modify or replace these Terms at any time. By continuing to access or use our Service after those revisions become effective, you agree to be bound by the revised terms.
                </p>

                <h2 className="text-2xl font-bold mb-4 mt-8 text-foreground border-b pb-2">Contact Us</h2>
                <p>
