...
const AuthPage = () => {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.message === 'Email not confirmed' || error.code === 'email_not_confirmed') {
        ...
        toast.error('Email not confirmed', 'Please check your email and click the confirmation link, or resend the confirmation email.');
      } else {
  ...
  const handleResendConfirmation = async () => {
    ...
    try {
      ...
      toast.success('Confirmation email sent', 'Please check your email for the confirmation link');
